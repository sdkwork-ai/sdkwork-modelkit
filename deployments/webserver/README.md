...
Module `sdkwork-modelkit` · runtime code `modelkit` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `modelkit-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `modelkit-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `modelkit-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `modelkit-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `modelkit.sdkwork.com` | 443 ssl + 80 |
