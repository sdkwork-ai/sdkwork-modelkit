# Runbook — sdkwork-modelkit deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-modelkit-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-modelkit/bundle`, loads the image, starts
